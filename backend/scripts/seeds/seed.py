...
def seed():
    ...
    try:
        ...
        default_roles = [
            ...
            {"name": "HR", "permissions": '{"employees": true, "leaves": true, "departments": true, "reports": true}'},
            {"name": "Manager", "permissions": '{"employees": true, "sites": true, "tasks": true, "reports": true, "dashboard": true}'},
            {"name": "Supervisor", "permissions": '{"employees": true, "sites": true, "tasks": true, "attendance": true}'},
            {"name": "Field Employee", "permissions": '{"attendance": true, "tasks": true, "expenses": true, "leaves": true}'},
        ]
