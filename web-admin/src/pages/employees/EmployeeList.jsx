...
export default function EmployeeList() {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await employeeService.importEmployees(fd);
      
      let msg = `Import complete! Created: ${res.data.created} employees.`;
      ...
      alert("Failed to import employees CSV");
    } finally {
      setLoading(false);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const detail = err.response?.data?.detail;
      alert(`Error deleting employee: ${detail || 'Unknown error'}`);
    }
  };
    ...
    <div className="animate-fade-in">
      ...
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="btn btn-secondary btn-sm" title="Import CSV" onClick={handleImportClick}>
            <Upload size={14} /> Import
          </button>
          <button className="btn btn-secondary btn-sm" title="Export CSV" onClick={handleExport}>
            ...
            <form onSubmit={handleSave}>
              <div className="modal-body">
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    <label className="form-label">{editingEmployee ? 'New Password (Optional)' : 'Password *'}</label>
                    <input className="form-input" type="password" placeholder={editingEmployee ? 'Leave blank to keep current' : 'Min 6 characters'} value={formData.password}
